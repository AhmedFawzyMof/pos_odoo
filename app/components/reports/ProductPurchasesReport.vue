...
defineProps<{ dateFrom: string; dateTo: string; locationId?: number | null }>();
...
<template>
  <BaseReport ref="baseRef" report-type="product_purchases" :date-from :date-to :location-id @loading="emit('loading', $event)" />
</template>
